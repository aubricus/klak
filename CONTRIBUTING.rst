...
Ready to contribute? Here's how to set up `klak` for local development.

1. Fork the `klak` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/klak.git
...
3. The pull request should work for Python 3.5 and 3.6, and for PyPy. Check
   https://travis-ci.org/aubricus/klak/pull_requests
